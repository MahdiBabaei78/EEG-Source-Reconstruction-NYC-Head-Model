function cmap = ft_colormap_inourcode(fighandle, varargin)
% Original file: ft_colormap(Fieldtrip toolbox)
% Modified file: ft_colormap_inourcode
% Date: April 15, 2024
% Copyright (C) 2024 Mahdi Babaei

% This file has been modified from its original version. The following 
% changes have been made:
% 1. To update the UI figure, I modified the Fieldtrip code to get the figure
% handle manually, instead of using the gcf MATLAB function. (Line 137)
